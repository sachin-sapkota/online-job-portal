              ...
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-600 dark:text-gray-200 font-nunito">
                    JobXa is different form other online job boards in many
                    ways. It is a job board that is focused on the job seekers.
                    <br />
                    <ul className=" list-disc  ">
                      <li className="">
                        First, you won't find scams, too-good-to-be-true
                        business opportunities,ads, commision-only jobs.
                      </li>
                      <li>
              ...
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-600 dark:text-gray-200 font-nunito">
                    ...
                    specific requirements for one or more positions, please
                    click “Apply for this Job” and complete all fields on the
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-600 dark:text-gray-200 font-nunito">
                    I no postion meets my current interest, you can Submit
                    Resume to us for future consideration. We can put it in our
                    database which will be searchable by recruiters when future
                    position arise.
                    <br />
                    <ul className=" list-disc  ">
                      <li className="">
